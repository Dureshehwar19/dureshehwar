...
const Navbar = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      ...
      <Link href={"#Skill"} className="mr-5 hover:text-red-600">Skills</Link>
    ...
    <button className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">My Resume
